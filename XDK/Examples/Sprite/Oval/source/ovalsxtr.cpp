...
BEGIN_XTRA
	...
	BEGIN_XTRA_DEFINES_CLASS(COvalSpriteRegister, XTRA_CLASS_VERSION)
		CLASS_DEFINES_INTERFACE(COvalSpriteRegister, IMoaRegister, XTRA_CLASS_VERSION)
	END_XTRA_DEFINES_CLASS

	BEGIN_XTRA_DEFINES_CLASS(COvalSpriteAsset, XTRA_CLASS_VERSION)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(COvalSpriteAsset, IMoaInitFromDict, XTRA_CLASS_VERSION)
		#endif
		CLASS_DEFINES_INTERFACE(COvalSpriteAsset, IMoaMmXAsset, XTRA_CLASS_VERSION)
	END_XTRA_DEFINES_CLASS

	BEGIN_XTRA_DEFINES_CLASS(COvalSpriteActor, XTRA_CLASS_VERSION)
		CLASS_DEFINES_INTERFACE(COvalSpriteActor, IMoaMmXSpriteActor, XTRA_CLASS_VERSION)
	END_XTRA_DEFINES_CLASS
