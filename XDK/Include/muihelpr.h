...
typedef IMoaDrValueHelper			* PIMoaDrValueHelper;
typedef IMoaMmValueHelper			* PIMoaMmValueHelper;
typedef IMoaMmUtils2Helper			* PIMoaMmUtils2Helper;
typedef IMoaDrPaletteAccessHelper	* PIMoaDrPaletteAccessHelper;
typedef IMoaNotificationHelper		* PIMoaNotificationHelper;
typedef IMoaMmWndWinHelper			* PIMoaMmWndWinHelper;
typedef IMoaMmWndMacHelper			* PIMoaMmWndMacHelper;
typedef IMoaDrSoundHelper			* PIMoaDrSoundHelper;
typedef IMoaMmAssetCallback2Helper	* PIMoaMmAssetCallback2Helper;
typedef IMoaMmLinearListHelper		* PIMoaMmLinearListHelper;
typedef IMoaMmPropListHelper		* PIMoaMmPropListHelper;
typedef IMoaMmValueCoercionHelper	* PIMoaMmValueCoercionHelper;

typedef IMoaDrPrefsHelper			* PIMoaDrPrefsHelper;
