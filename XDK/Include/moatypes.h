...
typedef struct _MoaStringRef * MoaStringRef;
...
#define		kMoaErr_DamagedFileContent		MAKE_MOAERR(24)	/* File content has been fuzzed. This error is used to prevent security issues */
