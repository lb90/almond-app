...
#define kMoaMmGCType_MacCALayer	8
#define kMoaMmGCType_IOSView	9
#define kMoaMmGCType_CGContext	10

#ifdef MACINTOSH
#if MAC_OS_X_VERSION_MIN_REQUIRED >= MAC_OS_X_VERSION_10_5 
#define CALAYER_AVAILABLE 1
#else
#define CALAYER_AVAILABLE 0
#endif
#endif
...
typedef struct
{
	...
	union
	{
		...
		{
			PMoaVoid	        calayerPtr;
			PMoaVoid			contextBounds;  /* a pointer to CALayer */
		} mac_calayer;
#endif /* MACINTOSH */
...
#ifdef _IOS
#define kMoaMmEvent_TouchDown           35
#define kMoaMmEvent_TouchUp             36
#endif
...
typedef MoaMmXFilterInfo* PMoaMmXFilterInfo;
...
#define     kMoaMmErr_ByteArray_EOF_Reached		MAKE_MOAERR(kMoaMmErr_Base + 40)
