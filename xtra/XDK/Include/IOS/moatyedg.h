/*==========================================================================\
|                                                                           |
|       Copyright (c) 1995-2011 Adobe Macromedia Software LLC, Inc.         |
|                                                                           |
...
#if (defined(_IOS) || defined(IOS))
	#define MOAPLATFORM_IOS
	#define MOA_PLATFORM_NAME   "MaIOS"
#endif
...
#ifdef _IOS
#endif
#define _MOA_DEBUGSTR_(cstr) do {  } while (0)
...
#define CGRectToMoaRect(a,b)   do { \
                            (b)->top    = (MoaCoord)(a)->origin.y;   \
                            (b)->left   = (MoaCoord)(a)->origin.x;  \
                            (b)->bottom = (MoaCoord)((a)->size.height+(a)->origin.y);\
                            (b)->right  = (MoaCoord)((a)->size.width+(a)->origin.x); \
                            } while (0)

#define MoaRectToCGRect(a,b)    do { \
                            (b)->origin.x = (CGFloat)(a)->left; \
                            (b)->origin.y = (CGFloat)(a)->top; \
                            (b)->size.width = (CGFloat)((a)->right-(a)->left); \
                            (b)->size.height = (CGFloat)((a)->bottom-(a)->top); \
                            } while(0)

#define GetCGRectFromMoaRect(a) CGRectMake((CGFloat)(a)->left, (CGFloat)(a)->top, (CGFloat)((a)->right-(a)->left), (CGFloat)((a)->bottom-(a)->top))
...
#define _MOA_XCODE_PREFACE \
    MoaFileRef DLL(gXtraFileRef) = kMoaFileRef_NoRef; \
    EXTERN_C void DLL(ppcSetFileRef)(MoaFileRef fileRef); \
    void DLL(ppcSetFileRef)(MoaFileRef fileRef) { DLL(gXtraFileRef) = fileRef; }
