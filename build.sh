...
SOURCES="main.m mangler.m clipboard.m diskserial.m platformserial.m util.m"
...
./i386-$COMPILER $FLAGS $FRAMEWORKS $SOURCES -o "i386/$ALMOND_BIN"
./i386-$COMPILER -g $FLAGS $FRAMEWORKS $SOURCES -o "i386/$ALMOND_DEBUG_BIN" -DALMOND_DEBUG
./x86_64-$COMPILER $FLAGS $FRAMEWORKS $SOURCES -o "x86_64/$ALMOND_BIN"
